    ...
    if(!$results||!$result_st_name) 
		...
		else 
        {
         ...
         //echo $stu_ans[$i]."s ".$q_ans[$i]." ".$stu_mark[10]." ".$stu_ans[$i]." ".$q_ans[$i]." ".$i;
            ...
            echo "<b style=margin-left:20%;>Marks Obtained :</b>".$stu_tot_mark;
            echo "<br/><hr width=80%;><center><b>Subject Wise Analysis</b></center>";
        ...
        else 
        {
            ...
            {   $row=$sub_res->fetch_assoc();
             ...
             echo "Subject : ".$row['subject']." Number of question : ".$row6_1." ";
