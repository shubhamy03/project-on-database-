...
<body style="margin-top:0px;">
    <header class="header_nav">
            ...
            <div class="l2_nav">
                <span class="li_nav5">(Name)</span>
                <span class="li_nav6">My Dashboard</span>
                <span class="li_nav7">Logout</span>
            </div>
        </header>
    ...
    <div class="bt11">
        <div class="btn_1" style="background:#ffffe6;
            ...
            <table border="1" width="100%">
                <b><tr><td>S.no</td><td>Exam</td><td>Set number</td><td>Score</td></tr></b>
...
<div class="right_nav">
    <div class="right_nav_inside">
        ...
        <div class="activity_text" style="width:auto;height:320px;
                                          background:#ffffe6;" >
            <center><p style="font-size:25px;margin-top:0px;font-family: sans-serif;">Hello,<b> <?php echo "shubham"; ?></b><br />
                Welcome to Virtual Exam Control.</p>
            <hr style="width:70%;color:#e6e6e6;">
               <p style="font-family: Tahoma, Arial, sans-serif;"> You may like to explore NDL through following<br /> activities</p>
            <hr style="width:70%;color:#e6e6e6;">
                <ul>
                    <li><div class="browser"><center>Browser</center></div></li>
                    <li><div class="search"><center>Search</center></div></li>
                </ul>
            </center>
        </div>
    </div>
