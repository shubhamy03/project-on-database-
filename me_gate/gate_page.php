...
<ul class="l2"><li>Log in</li><li>Sign Up</li><li>My profile</li></ul></header>
    ...
    <div style="background:#F5F5F5;">
          <center><img src="image/me.jpg" style="margin-top:60px;margin-bottom:10px;display:inline;"width="30%">
        
              <img src="image/gate_cse_page_image.jpg" style="margin-top:60px;margin-bottom:10px;display:inline;"width="30%">    
              
        <img src="image/syllabusme2.jpg" style="margin-top:60px;margin-bottom:10px;display:inline;" width="30%">
              
        
        </center></div>
    
    <form name="question_paper" method="post" action="../question.php">
        <input type ="submit" class="bt1" name="exam_name" value="Give GATE ME TEST" id="bt_1" style="display:inline;">
...
$link=new mysqli('localhost','root','','vec2');
    ...
    $query="SELECT number_of_set FROM `exam` WHERE exam_name='GATE ME';";
