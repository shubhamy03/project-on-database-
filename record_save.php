...
<body style="margin-top:0px;">
        ...
        <header class="header_nav">
            ...
            <div class="l2_nav">
                <span class="li_nav5"><?php echo "Welcome <b>".$user_name."</b>";?></span>
                 <span class="li_nav7"><a href="logout.php">Logout</a>
...
<body>
    ...
    echo "<b>Exam name : ".$exam_name." </br>Set NO :".$setno."</br>Marks : ".$marks;
    
     $link=new mysqli('localhost','root','','vec2');
    if(mysqli_connect_error()){ 
        echo "unable to connect to localhost";
        }
    $query="INSERT INTO `student_gives` (`student_id`, `exam_name`, `score`, `set_number`) VALUES ('$login', '$exam_name', '$marks', '$setno')";
    
    $results=$link->query($query);
    if($results) 
    {$data='Error in insert to table '; }
		else 
        {$data='Successfully Data Save !';}
    
    ?>
    <div style="background-color:#708090;color:white;padding:20px;">
<p class="sansserif"> <?php echo $data;?></p></div>
    <center></br>
